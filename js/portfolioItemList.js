...
$(window).load(function() {
    ...
    function renderThumbnail(item) {
        var $newItem = $('<div class="sorting-item filter-' + item.cat + '">' + '  <div class="homepage-portfolio-preview-1 new-animation">' + '    <a id="pitem-' + item.id + '" class="" href="./img/portfolio/' + item.id + '_D.' + item.type + '">' + '      <span class="background full-size" style="background-image: url(./img/portfolio/' + item.id + '.' + item.type + ');">' + '      </span>' + '      <span class="text">' + '        <span class="h4 light">' + item.title + '</span>' + '        <span class="empty-space col-xs-b15"></span>' + '        <span class="simple-article large light transparent">' + item.desc + '</span>' + '      </span>' + '    </a>' + '  </div>' + '</div>');
